...
The first time I tried this I grabbed everything from Google Scholar: don't do this!!
The zotero conversions from Google Scholar seem to be missing the doi information, and the doi is used to make html links to papers. 
